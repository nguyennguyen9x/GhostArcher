...
import { _decorator, Component, Node, Enum, EventTouch, UITransform, Vec3, view } from "cc";
...
export class Joystick extends Component {
    ...
    public set onClickCb (v: Function) {
        this._onClickCb = v;
    }

    public get onClickCb () {
        return this._onClickCb;
    }

    public set onEndCb (v: Function) {
        this._onEndCb = v;
    }
    ...
    public set clearFECb (v: Function) {
        this._clearFECb = v;
    }

    public get clearFECb () {
        return this._clearFECb;
    }

    public set onBeginFECb (v: Function) {
        this._onBeginFECb = v;
    }

    public get onBeginFECb () {
        return this._onBeginFECb;
    }

    public set onSuccessFECb (v: Function) {
        this._onSuccessFECb = v;
    }

    public get onSuccessFECb () {
    ...
    private _onClickCb: Function = null!;
    private _onEndCb: Function = null!;
    private _clearFECb: Function = null!;
    private _onBeginFECb: Function = null!;
    private _onSuccessFECb: Function = null!;
